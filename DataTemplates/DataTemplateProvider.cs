...
public static class DataTemplateProvider
{
    public static FuncDataTemplate<Person> GenderDataTemplate { get; } =
        new(person => person is not null, BuildGenderPresenter);
    ...
    private static Control BuildGenderPresenter(Person person)
    {
        ...
        switch (person.Sex)
        {
            ...
            case Sex.Male:
                path.Data = StreamGeometry.Parse(
                    "m 178.125,37.539801 a 9.375,9.375 0 0 1 0,-18.75 h 93.75 a 9.375,9.375 0 0 1 9.375,9.375 V 121.9148 a 9.375,9.375 0 0 1 -18.75,0 V 50.796051 L 185.08125,128.2148 A 93.75,93.75 0 1 1 171.825,114.95855 L 249.24375,37.539801 Z M 112.5,112.5398 a 75,75 0 1 0 0,150 75,75 0 0 0 0,-150 z");
